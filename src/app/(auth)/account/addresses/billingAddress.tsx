...
function DefaultBillingAddress({
  ...
  defaultBillingAddress: Maybe<Address> | undefined;
}) {
  const address = defaultBillingAddress;
  ...
  console.log(address, isNewAddress, addressId);
      ...
      if (isNewAddress && !addressId) {
        ...
        if (errors && errors?.length > 0) {
          ...
          addToast({
            ...
            description: "Your Billing Address is created successfully!",
            color: "success",
          });
        }
        return;
